...
const Live = () => {
  ...
  return (
    <section id="live" className="py-20 bg-gradient-to-br from-cream via-soft-pink to-cream">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <Radio className={`w-8 h-8 ${isLive ? 'text-primary-red animate-pulse' : 'text-dark-gray/50'}`} />
            <h2 className="text-4xl md:text-5xl font-playfair font-bold text-dark-gray">
              {isLive ? 'Live Now' : 'Not Live'}
            </h2>
            <Radio className={`w-8 h-8 ${isLive ? 'text-primary-red animate-pulse' : 'text-dark-gray/50'}`} />
          </div>
          <p className="text-lg text-dark-gray/80 font-lato max-w-2xl mx-auto">
            {isLive 
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            {isLive ? (
              <>
                {/* Live Indicator */}
                <div className="bg-primary-red text-white py-3 px-6 flex items-center justify-center gap-3">
              ...
              <>
                {/* Not Live Message */}
                <div className="bg-dark-gray/10 text-dark-gray py-3 px-6 flex items-center justify-center gap-3">
                ...
                <div className="relative w-full bg-gradient-to-br from-soft-pink via-cream to-soft-pink" style={{ paddingBottom: '56.25%' }}>
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                    <motion.div
                      ...
                      transition={{ duration: 0.6 }}
                    >
                      <Radio className="w-24 h-24 text-primary-red mb-6 mx-auto" />
                      <h3 className="text-3xl md:text-4xl font-playfair font-bold text-dark-gray mb-4">
                        We'll Be Live Soon!
                      </h3>
                      <p className="text-lg text-dark-gray/80 font-lato mb-6 max-w-md">
                        Join us every Sunday at 8:00 PM EST for live broadcasts filled with love, music, and meaningful conversations.
                      </p>
                      <div className="flex items-center justify-center gap-2 text-primary-red font-montserrat font-semibold">
            ...
            {/* Schedule Info */}
            <div className="bg-gradient-to-r from-soft-pink to-cream p-6">
              <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-dark-gray">
          ...
          >
            <p className="text-dark-gray/70 font-lato mb-4">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block bg-primary-red text-white px-8 py-3 rounded-full font-montserrat font-semibold hover:bg-primary-red/90 transition-colors shadow-lg"
            >
              View Past Episodes
            </motion.a>
          </motion.div>
